...
Future<void> main() async {
  ...
  runApp(AutoPortApp(bootstrapError: bootstrapError));
}
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: Color(0xFF1E9EB9), width: 1.4),
        ),
        contentPadding: const EdgeInsets.symmetric(
          horizontal: 16,
          vertical: 16,
        ),
        hintStyle: const TextStyle(color: Color(0xFF95A6B8)),
      ),
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        indicatorColor: const Color(0xFF1E9EB9).withValues(alpha: 0.2),
        labelTextStyle: WidgetStateProperty.resolveWith(
          (states) => TextStyle(
            color: states.contains(WidgetState.selected)
                ? const Color(0xFFBCEAF2)
                : const Color(0xFF8FA7BC),
